...
- [BAN France Address Validation](https://l402-ban-api.onrender.com)
- [Healthcare Context Extraction](https://l402-health-ctx.onrender.com) - Extract structured clinical context (patient, encounters, medications, diagnoses, alerts, timeline) from French/EU healthcare documents: CDA r2, HL7 v2.x, FHIR R4, PDF. 10 sats per request. [Source](https://github.com/fredericsuretat/l402-health-ctx). - French address validation & geocoding (Base Adresse Nationale). 5 sats per request, agent discovery manifest at `/.well-known/l402.json`. [Source](https://github.com/fredericsuretat/l402-ban-api).
