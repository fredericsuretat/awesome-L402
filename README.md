...
- [BAN France Address Validation](https://l402-ban-api.onrender.com) - French address validation & geocoding (Base Adresse Nationale). 5 sats per request, agent discovery manifest at `/.well-known/l402.json`. [Source](https://github.com/fredericsuretat/l402-ban-api).
